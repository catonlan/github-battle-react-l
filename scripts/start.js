...
process.env.NODE_ENV = 'development'; // 全局node 环境变量
...
// 下面就是对应devserver 的详细配置了， open,host, port,http, propxy，等，都是从对应的文件中读取，env.js, package.json等
